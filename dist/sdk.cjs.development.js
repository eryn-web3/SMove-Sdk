...
(function (ChainId) {
  ChainId[ChainId["GOHEAL"] = 3901] = "GOHEAL";
...
Currency.ETHER = {
  3901: /*#__PURE__*/new Currency(18, 'GOH', 'GoHeal'),
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'SMove-LP', 'SMove LPs');
